...
public class User {
    ...
    public static User createUser() {
        ...
        String userRole;
        while(true) {
            System.out.print("Enter User Role(Admin/Patient/Doctor): ");
            userRole = x.nextLine();
            if(userRole.equalsIgnoreCase("patient")||userRole.equalsIgnoreCase("admin")||userRole.equalsIgnoreCase("doctor")){
                break;
            }
            else{
                System.out.println("The role you entered is not valid");
            }
        }
        User newUser;
